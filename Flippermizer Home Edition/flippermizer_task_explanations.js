...
(function(root){
  ...
  const SCORE_TARGET_OVERRIDES_BY_TABLE = Object.freeze({
    ...
    [normalizeTableKey("Attack from Mars")]: Object.freeze({
      easy: Object.freeze(["371,293,964+"]),
      medium: Object.freeze(["896,531,739+"]),
      hard: Object.freeze(["1,794,034,514+"])
    }),
    [normalizeTableKey("Harlem Globetrotters")]: Object.freeze({
      easy: Object.freeze(["44,890+"]),
      medium: Object.freeze(["121,215+"]),
      hard: Object.freeze(["262,375+"])
    }),
    [normalizeTableKey("Scared Stiff")]: Object.freeze({
      easy: Object.freeze(["950,000+"]),
      medium: Object.freeze(["2,500,000+"]),
      hard: Object.freeze(["5,200,000+"])
    }),
    [normalizeTableKey("Tales of the Arabian Nights")]: Object.freeze({
      easy: Object.freeze(["750,000+"]),
      medium: Object.freeze(["2,200,000+"]),
      hard: Object.freeze(["4,900,000+"])
    })
  });
  ...
  const EXACT = Object.freeze({
    ...
    "defeat ringmaster once": "Spell W-O-W to summon the Ringmaster, hit him five times, then shoot under him to finish one full Ringmaster defeat.",
    "defeat ringmaster twice": "Summon and defeat the Ringmaster two separate times in the same game.",
    "defeat ringmaster 3 times in one game": "Summon and defeat the Ringmaster three separate times before the game ends.",
    ...
    "complete 1 marvel": "Collect any one Cirqus Marvel through Ringmaster, Side Show, Highwire, Juggler, Acrobats, Menagerie, Boom, or Spin progress.",
    ...
    "complete 4 marvels in one game": "Collect four different Cirqus Marvels before the game ends. Ringmaster, Side Show, Highwire, Juggler, Acrobats, Menagerie, Boom, and Spin progress all count.",
  ...
  const TABLE_TASK_GUIDES = Object.freeze({
    ...
    "the getaway": {
      ...
      "complete the 1 2 3 standup targets": "Hit all three 1-2-3 standup targets to light a one-shot Supercharger Boost at the left ramp.",
    ...
    "tales of the arabian nights": {
      ...
      "complete 3 tales in one game": "Genie modes (the \"tales\") - Start tales by hitting the Genie, then finish the lit shot requirements for three separate tales before the game ends. Many tales complete in a few shots, but you must collect the jewel/reward before starting the next one.",
    ...
    "congo": {
      ...
      "spell c o n g o once": "C-O-N-G-O letters - Collect the lit C, O, N, G, and O letters from the CONGO letter shots, lanes, and rollovers. Complete the full five-letter sequence once for this task.",
      "collect a lit map award": "Left ramp and Map awards - The left ramp collects letters in the word Map. Collecting the M or A will put the ball on the right flipper for another shot at the left ramp. Collecting the P will light the right saucer for a Map award, and put the ball on the left flipper for a shot at that award. Collect one lit Map award to clear this task.",
      ...
      "lock 1 ball for multiball": "Locks and multiball - Collect 4 Diamonds to light a lock. Locks can be made at the left orbit or the upper flipper shot that goes under the volcano. Lock one ball to satisfy this task; full Congo Multiball still needs three locked balls or the second Gray Attack completion.",
    ...
    "harlem globetrotters": {
      ...
      "light 5x bonus once": "Bonus - Bonus is a huge part of Harlem Globetrotters. Take special care not to tilt. The right in lane and top saucer award 3 bonus advances; in line drop targets and 5 spins of the lit center spinner award 1 bonus advance. Light 5X bonus once to clear this task.",
      "light the spinner to 2 000 and rip it": "Left spinner - Is worth a measly 10 points per spin at the beginning of the ball. Each in line drop target knocked down increases its value for the rest of the ball, to 100, then 200, then 1,000, and finally 2,000 points per spin. When this spinner is lit for maximum value, nothing comes close to being as valuable as a shot, it should be top priority for any ball on the right flipper.",
      "rip the spinner 3 times": "Left spinner - Send the ball through the left spinner lane three times. Building the spinner value with the in line drops is still valuable, but this task only requires three spinner lane shots.",
    ...
    "paragon": {
      ...
      "collect the static 20000 end of ball bonus": "Bonus and bonus multiplier - Build the static bonus to 20,000 or higher, then let the end-of-ball bonus count down and collect it. Bonus multiplier can make this much larger, but the task is about reaching the 20,000+ static bonus before the multiplier."
    },
    "robocop": {
    ...
    "high speed": {
      ...
      "make 3 freeways on one ball": "Freeways - A Freeway is a lit full-orbit award. Make an orbit shot, or roll through an inlane to light the opposite orbit, then shoot the lit full orbit before the short timer expires. Collect three Freeway awards on the same ball; the value advances through 25,000, 50,000, 75,000, 100,000, then Extra Ball.",
    ...
    "scared stiff": {
      ...
      "collect 3 spider wheel awards in one game": "Right ramp and the Spider Wheel - Shoot the right ramp to light the Spider hole, then shoot the Spider hole to spin and collect an award. Collect three separate Spider Wheel awards before the game ends.",
    ...
    "bram stoker s dracula": {
      ...
      "collect any multiball award": "Multi-Multiball - Start Castle, Coffin, or Mist Multiball, then collect any lit multiball award or jackpot. Castle awards are at the Tunnel saucer, Coffin jackpots are on the ramps, and Mist can stack with the other multiballs.",
      "lock 2 castle multiball balls": "Light Castle locks from left-ramp awards, then shoot the left ramp to lock two balls toward Castle Multiball.",
      ...
      "start any multiball and collect any multiball award": "Multi-Multiball - Start Castle, Coffin, or Mist Multiball, then collect any lit multiball award or jackpot before the multiball ends. Stacking two or three multiballs doubles or triples the available jackpot scoring.",
    ...
    "creature from the black lagoon": {
      "collect the slide or kiss letters": "Shoot the Slide lane or KISS lane to collect its F-I-L-M letter. Either letter path satisfies this task.",
      ...
      "start move your car and shoot it twice": "Shoot the center Move Your Car lane until the mode starts, then make two lit center-lane shots during the mode.",
    ...
    "demolition man": {
      ...
      "start 2 modes in one game": "Qualify the Cryo-Claw, collect any mode award, then repeat to start a second mode in the same game. Completing the modes is not required.",
    ...
    "goldeneye": {
      ...
      "start q s pen mode": "Q's Pen - Hit either Q target three total times to start Q's Grenade Pen mode. Completing the timed mode is not required.",
    ...
    "freddy a nightmare on elm street": {
      ...
      "shoot either loop 3 times": "Shoot the left loop or right loop three total times; either loop counts toward this task.",
      ...
      "reach 2 nightmares in one ball": "Fall Asleep twice before the ball drains. Light or shoot the Boiler Room to start each Nightmare, then survive long enough to reach the next one.",
    ...
    "lord of the rings": {
      ...
      "collect a jackpot in any main multiball": "Start Fellowship, Two Towers, or Return of the King Multiball, then shoot any lit jackpot shot before the multiball ends.",
