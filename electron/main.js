...
const APP_ICON_HOME_IMAGE = path.join(__dirname, "..", "Flippermizer Images", "FM-Icon64x64.png");
const APP_ICON_PACKAGE = path.join(__dirname, "..", "build", process.platform === "win32" ? "icon.ico" : "icon.png");
